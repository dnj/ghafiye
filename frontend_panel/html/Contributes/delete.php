	...
	<div class="col-md-12">
		<div class="panel panel-danger">
			<div class="panel-heading">
				<i class="fa fa-trash"></i> <?php echo translator::trans("ghafiye.panel.contributes.delete"); ?>
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-sm-6">
						<form action="<?php echo userpanel\url("contributes/delete/{$this->contribute->id}"); ?>" method="POST">
							<div class="row">
								<div class="col-xs-12">
									<div class="alert alert-danger" role="alert">
										آیا از حذف مشارکت اطمینان دارید ؟ تمامی اقدامات انجام شده پاک خواهند شد.
									</div>
								</div>
							</div>
							<div class="row">
