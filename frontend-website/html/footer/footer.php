...
<footer>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
				...
				<ul class="socialnetworks">
					<li><a href="<?php echo base\url('telegram'); ?>"><i class="fa fa-telegram"></i> <?php echo translator::trans('footer.link.telegram'); ?></a></li>
		...
		<div class="note">
			...
			<div class="copyright"><?php echo translator::trans('footer.copyright'); ?></div>
		</div>
	</div>
</footer>
<?php $this->loadJS(); ?>
