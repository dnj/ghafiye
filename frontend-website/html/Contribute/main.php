...
<div class="row">
	<div class="col-sm-8 col-sm-push-4">
		...
		<div class="panel panel-white panel-synce">
				...
				<ul class="list-group tracks">
					...
					<li class="list-group-item">
						<div class="row">
							...
							<div class="col-sm-3 col-xs-3">
								<a href="<?php echo base\url("song/synce/{$track->id}"); ?>" class="btn btn-sm btn-block btn-default btn-synce"><span class="hidden-xs"><?php echo translator::trans("ghafiye.contribute.synce"); ?></span><span class="visible-xs"><i class="fa fa-check-square-o"></i></span></a>
							</div>
						</div>
					</li>
					<?php } ?>
			...
			<div class="panel-footer">
				<a class="btn-more-sync-track" href="<?php echo base\url("contribute/synce"); ?>"><?php echo translator::trans("ghafiye.contribute.load.more"); ?></a>
			</div>
		</div>
	</div>
