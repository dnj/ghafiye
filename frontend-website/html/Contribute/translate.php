					...
					<li class="list-group-item">
						<div class="row">
							...
							<div class="col-sm-3 col-xs-3">
								<a href="" class="btn btn-sm btn-block btn-default btn-translate"><span class="hidden-xs"><?php echo translator::trans("ghafiye.contribute.translate"); ?></span><span class="visible-xs"><i class="fa fa-edit"></i></span></a>
							</div>
						</div>
					</li>
					<?php } ?>
